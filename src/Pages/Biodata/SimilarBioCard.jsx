...
function SimilarBioCard({similarCard }) {
  ...
  return (
    <div className='border font-bannerFont rounded-xl bg-white dark:bg-purple-200'>
    <div className='bg-pink-400 dark:bg-gray-400 flex flex-col justify-center items-center py-10 rounded-tl-full  relative '>
