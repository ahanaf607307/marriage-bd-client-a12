...
function BioDataCard() {
  return (
    <div className='border-2 font-bannerFont rounded-xl'>
       ...
       <Link className=''><Button className='w-10/12 mx-auto outline-none mb-7 hover:bg-gradient-to-r from-pink-300 to-pink-700 border-2 border-pink-500 text-pink-500 hover:text-white duration-100 hover:border-white bg-transparent'  >
        View Profile 
      </Button></Link>
    </div>
  )
